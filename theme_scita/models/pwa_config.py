...
class WebsiteInherit(models.Model):
    ...
    pwa_app_name = fields.Char("Application Name", traslate=True, default='Appjetty PWA')
    pwa_app_short_name = fields.Char("Application Short Name", traslate=True, default='Appjetty')
    ...
    pwa_app_icon_512 = fields.Binary(string="Application Image(Size 512x512)", help="""Upload Image Size(512x512) and its must be PNG format""")
