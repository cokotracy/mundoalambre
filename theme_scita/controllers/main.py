...
class ScitaSliderSettings(http.Controller):
    ...
    def scita_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.website.viewref("theme_scita.theme_scita_blog_slider_view").render(values)
    ...
    def health_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            values = self.get_blog_data(post.get('slider-type'))
            return request.website.viewref("theme_scita.health_blog_slider_view").render(values)
    ...
    def second_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            values = self.get_blog_data(post.get('slider-type'))
            return request.website.viewref("theme_scita.scita_blog_2_slider_view").render(values)
    ...
    def third_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            values = self.get_blog_data(post.get('slider-type'))
            return request.website.viewref("theme_scita.scita_blog_3_slider_view").render(values)
    ...
    def six_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            values = self.get_blog_data(post.get('slider-type'))
            return request.website.viewref("theme_scita.scita_blog_6_slider_view").render(values)
    ...
    def forth_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            values = self.get_blog_data(post.get('slider-type'))
            return request.website.viewref("theme_scita.scita_blog_4_slider_view").render(values)
    ...
    def fifth_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            values = self.get_blog_data(post.get('slider-type'))
            return request.website.viewref("theme_scita.scita_blog_5_slider_view").render(values)

    @http.route(['/theme_scita/seven_blog_get_dynamic_slider'], type='json', auth='public', website=True)
    def seven_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            values = self.get_blog_data(post.get('slider-type'))
            return request.website.viewref("theme_scita.scita_blog_7_slider_view").render(values)
    ...
    def eight_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            values = self.get_blog_data(post.get('slider-type'))
            return request.website.viewref("theme_scita.scita_blog_8_slider_view").render(values)
    ...
    def get_clients_dynamically_slider(self, **post):
        ...
        return request.website.viewref("theme_scita.theme_scita_client_slider_view").render(values)
    ...
    def second_get_clients_dynamically_slider(self, **post):
        values = self.get_clients_data()
        return request.website.viewref("theme_scita.second_client_slider_view").render(values)
    ...
    def third_get_clients_dynamically_slider(self, **post):
        values = self.get_clients_data()
        return request.website.viewref("theme_scita.third_client_slider_view").render(values)
    ...
    def get_team_one_dynamically_slider(self, **post):
        ...
        return request.website.viewref("theme_scita.it_our_team_view").render(values)
    ...
    def get_team_two_dynamically_slider(self, **post):
        values = self.get_teams_data()
        return request.website.viewref("theme_scita.our_team_varient_2_view").render(values)
    ...
    def get_team_three_dynamically_slider(self, **post):
        values = self.get_teams_data()
        return request.website.viewref("theme_scita.our_team_varient_3_view").render(values)
    ...
    def get_team_four_dynamically_slider(self, **post):
        values = self.get_teams_data()
        return request.website.viewref("theme_scita.our_team_varient_4_view").render(values)
    ...
    def get_team_five_dynamically_slider(self, **post):
        values = self.get_teams_data()
        return request.website.viewref("theme_scita.our_team_varient_5_view").render(values)
    ...
    def get_team_six_dynamically_slider(self, **post):
        values = self.get_teams_data()
        return request.website.viewref("theme_scita.our_team_varient_6_view").render(values)
    ...
    def get_team_seven_dynamically_slider(self, **post):
        values = self.get_teams_data()
        return request.website.viewref("theme_scita.our_team_varient_7_view").render(values)
    ...
    def category_get_dynamic_slider(self, **post):
        if post.get('slider-id'):
            ...
            return request.website.viewref("theme_scita.theme_scita_cat_slider_view").render(values)
    ...
    def second_get_dynamic_cat_slider(self, **post):
        if post.get('slider-id'):
            values = self.get_categories_data(post.get('slider-id'))
            return request.website.viewref("theme_scita.second_cat_slider_view").render(values)

    @http.route(['/theme_scita/category_slider_3'], type='json', auth='public', website=True)
    def category_slider_value(self, **post):
        if post.get('slider-id'):
            values = self.get_categories_data(post.get('slider-id'))
            return request.website.viewref("theme_scita.theme_scita_category_slider_3_view").render(values)

    @http.route(['/theme_scita/category_slider_4'], type='json', auth='public', website=True)
    def category_slider_four(self, **post):
        if post.get('slider-id'):
            values = self.get_categories_data(post.get('slider-id'))
            return request.website.viewref("theme_scita.theme_scita_category_slider_4_view").render(values)
    ...
    def product_get_dynamic_slider(self, **post):
        if post.get('slider-id'):
            ...
            return request.website.viewref("theme_scita.theme_scita_product_slider_view").render(values)
    ...
    def retail_multi_get_dynamic_slider(self, **post):
        ...
        if post.get('slider-type'):
            ...
            return request.website.viewref("theme_scita.scita_multi_cat_slider_view").render(values)
    ...
    def fashion_multi_get_dynamic_slider(self, **post):
        ...
        if post.get('slider-type'):
            ...
            return request.website.viewref("theme_scita.fashion_multi_cat_slider_view").render(values)
    ...
    def custom_pro_get_dynamic_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.website.viewref("theme_scita.custom_scita_cat_slider_view").render(values)
    ...
    def custom_get_brand_slider(self, **post):
        ...
        return request.website.viewref("theme_scita.custom_scita_brand_slider_view").render(values)
    ...
    def get_product_column_five(self, **post):
        ...
        if post.get('slider-type'):
            ...
            return request.website.viewref("theme_scita.sct_product_snippet_1_view").render(values)
    ...
    def product_snippet_data_two(self, **post):
        ...
        if post.get('slider-type'):
            ...
            return request.website.viewref("theme_scita.sct_product_snippet_2_view").render(values)
...
class ScitaShop(WebsiteSale):
            ...
            if is_price_slider:
                ...
                if match_product:
                    for prod in match_product:
                        context = dict(request.env.context, quantity=1, pricelist=website_pricelist.id if website_pricelist else False)
                ...
                if price_list:
                    ...
                    if product_slider_ids:
                        ...
                        if request.session.get('min1') or request.session.get('max1'):
                            ...
                            request.session["pricerange"] = str(request.session['min1']) + "-To-" + str(request.session['max1'])
    ...
    def get_brand_slider(self, **post):
        if post.get('slider-type'):
            ...
            "theme_scita.retial_brand_snippet_1").render(values)
    ...
    def get_box_brand_slider(self, **post):
        if post.get('slider-type'):
            ...
            return request.website.viewref(
            "theme_scita.box_brand_snippet_4").render(values)
    ...
    def get_it_brand(self, **post):
        if post.get('slider-type'):
            ...
            return request.website.viewref(
            "theme_scita.it_brand_snippet_1").render(values)
    ...
    def config_cat_product(self, **post):
        ...
        values.update({'slider_type': slider_header.prod_cat_type})
        return request.website.viewref("theme_scita.product_category_img_slider_config_view").render(values)
...
class PWASupport(http.Controller):
    ...
    def pwa_manifest(self, website_id=None):
        ...
        current_website = website.search([('id', '=', website_id)]) if website_id else request.website
    ...
    def scita_quick_view_data(self,product_id=None):
        ...
        return request.env['ir.ui.view'].render_template("theme_scita.shop_quick_view_modal", {'product':product})

    @http.route("/theme_scita/shop/cart_view", type="json", auth="public", website=True)
    def scita_cart_view_data(self,product_id=None):
        product = request.env['product.template'].browse(int(product_id))
        return request.env['ir.ui.view'].render_template("theme_scita.shop_cart_view_modal", {'product':product})
