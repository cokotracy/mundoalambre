    ...
    def _run_buy(self, procurements):
        ...
        for domain, procurements_rules in procurements_by_po_domain.items():
            ...
            if not po:
                ...
                so_domain = [("company_id", "=", company_id.id),  ("name", "=",procurements[0].origin)]
                so = self.env['sale.order'].search(so_domain, limit=1) 
                po.fiscal_position_id=so.fiscal_position_id
            else:
